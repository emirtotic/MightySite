...
<title>Projects Page - Admin</title>
							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										...
										<a href="projects-form" class="btn btn-success"> <i
											class="fas fa-plus-square"></i> Add new Project
										</a>
									</div>
								</div>
								<!-- /.card-header -->
									...
									<table class="table table-bordered">
										...
										<tbody id="sort-list">
											...
											<c:forEach var="projects" items="${projectsList}">
												...
												<tr>
													<td>${projects.id}</td>
													<td><strong>${projects.image}</strong></td>
													
													
													<td class="text-center">
														<div class="btn-group">
														
														<a href="projects-form-update?id=${projects.id}"
																class="btn btn-info"> <i class="fas fa-edit"></i>
															</a>
															
															<button type="button" class="btn btn-info"
																data-toggle="modal"
																data-target="#delete-modal-${projects.id}">
												...
												<div class="modal fade" id="delete-modal-${projects.id}">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer justify-content-between">
																...
																<a href="project-delete?id=${projects.id}"
