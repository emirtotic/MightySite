...
<title>Workers Page - Admin</title>
							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										...
										<a href="workers-form" class="btn btn-success"> <i
											class="fas fa-plus-square"></i> Add new Worker
										</a>
									</div>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
									<table class="table table-bordered">
										...
										<tbody id="sort-list">
											...
											<c:forEach var="workers" items="${workersList}">

												<tr>
													<td>${workers.id}</td>
													<td><strong>${workers.name}</strong></td>
													<td><strong>${workers.position}</strong></td>
													<td><strong>${workers.message}</strong></td>
													<td><strong>${workers.image}</strong></td>

													<td class="text-center">
														<div class="btn-group">
															<a href="workers-form-update?id=${workers.id}"
															...
															<button type="button" class="btn btn-info"
																data-toggle="modal"
																data-target="#delete-modal-${workers.id}">
												...
												<div class="modal fade" id="delete-modal-${workers.id}">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-body">
																<p>Are you sure you want to delete worker?</p>
																<strong></strong>
															</div>
															<div class="modal-footer justify-content-between">
																<button type="button" class="btn btn-default"
																	data-dismiss="modal">Cancel</button>
																<a href="workers-delete?id=${workers.id}"
