...
<html lang="en">
  ...
  <head>
    <title>Mighty &mdash; Mighty Site - Pocetna</title>
    <meta charset="utf-8">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center">
              ...
              <p class="mb-4">Emir Totic - Student of <a href="https://cubes.edu.rs/" target="_blank"> Cubes School</a> in Belgrade, 
              					department for Java Web Development.</p>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-4">
            ...
            <p><a href="work-page" class="btn btn-primary text-white px-5">Our works</a></p>
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3">
            <div class="service-29128 text-center">
              ...
              <h3>Web Design</h3>
              <p>We do Web Design, front - end part of the project!</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="service-29128 text-center">
              ...
              <p>We do Graphic Design. I can draw whatever you want and put on your site. Be careful!</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="service-29128 text-center">
              ...
              <h3>Web Apps</h3>
              <p>Also, we develop any kind of web applications!</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="service-29128 text-center">
              ...
              <h3>Ecommerce</h3>
              <p>We have some experience in E-Commerce too. Sta ces vise od zivota?! :)</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 mx-auto text-center">
            <h2 class="heading-29190">Check Out Our Cubes Workspace</h2>
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-md-8">

            <a href="https://www.youtube.com/watch?v=eSoPayyDIz4" data-fancybox  class="btn-video_38929">
              <span><span class="icon-play"></span></span>
              <img src="images/CubesOffice.png" alt="Image" class="img-fluid">
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="site-section bg-white">
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 mx-auto text-center">
            <h2 class="heading-29190">Some of our Blogs</h2>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="${blogs.externalLink}">
                <img src="${blogs.image}" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
                
                <h2><a href="${blogs.externalLink}">${blogs.title}</a></h2>
                <span class="meta d-inline-block mb-3">${blogs.date} <span class="mx-2">by</span> <a href="work-page">${blogs.author}</a></span>
                <p>${blogs.text}</p>
              </div>
            </div>
          </div>
