							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										...
										<a href="blogs-form" class="btn btn-success"> <i
									...
									<table class="table table-bordered">
										...
										<tbody id="sort-list">
											...
											<c:forEach var="blogs" items="${blogsList}">
												...
												<tr>
													<td>${blogs.id}</td>
													<td><strong>${blogs.title}</strong></td>
													<td><strong>${blogs.text}</strong></td>
													<td><strong>${blogs.date}</strong></td>
													<td><strong>${blogs.author}</strong></td>
													<td><strong>${blogs.externalLink}</strong></td>
													<td><strong>${blogs.image}</strong></td>

													<td class="text-center">
														<div class="btn-group">
															<a href="blogs-form-update?id=${blogs.id}"
																class="btn btn-info"> <i class="fas fa-edit"></i>
															</a>
															<button type="button" class="btn btn-info"
																data-toggle="modal"
																data-target="#delete-modal-${blogs.id}">
												...
												<div class="modal fade" id="delete-modal-${blogs.id}">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer justify-content-between">
																...
																<a href="blog-delete?id=${blogs.id}"
