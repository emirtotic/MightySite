...
<head>
  ...
  <title>Workers Form - Admin</title>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form:form role="form" action="workers-save" modelAttribute="workers">
              ...
              <form:hidden path="id"/>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <form:input path="position" class="form-control" placeholder="Enter position"/>
                    
                    <label>Message</label>
                    <form:errors path="message" cssClass="text-danger" />
                    <form:input path="message" class="form-control" placeholder="Enter workers message"/>
                    ...
                    <div class="custom-control custom-checkbox">
                  	...
                  	<label for="customCheckbox1" class="custom-control-label">Show Worker On Page</label>
                  	</div>
