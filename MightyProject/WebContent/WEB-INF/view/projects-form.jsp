        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form:form role="form" action="project-save" modelAttribute="projects">
              ...
              <form:hidden path="id"/>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <form:input path="image" class="form-control" placeholder="Enter project URL"/>
