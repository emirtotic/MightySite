							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										...
										<a href="contact-form" class="btn btn-success"> <i
											class="fas fa-plus-square"></i> Add new Contact
										</a>
									</div>
								</div>
								<!-- /.card-header -->
										...
										<tbody id="sort-list">
											...
											<c:forEach var="contact" items="${contactsList}">
												...
												<tr>
													...
													<td><strong>${contact.surname}</strong></td>
													...
													<td class="text-center">
														...
														<a href="contact-form-update?id=${contact.id}"
