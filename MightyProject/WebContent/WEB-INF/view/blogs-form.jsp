          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Fill fields below</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form:form role="form" action="blogs-save" modelAttribute="blog">
              ...
              <form:hidden path="id"/>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <form:input path="title" class="form-control" placeholder="Enter Blog Title"/>
                    
                    <label>Text</label>
                    <form:errors path="text" cssClass="text-danger" />
                    <form:input path="text" class="form-control" placeholder="Enter Blog text"/>
                    
                    <label>Date</label>
                    <form:errors path="date" cssClass="text-danger" />
                    <form:input path="date" class="form-control" placeholder="Enter date"/>
                    
                    <label>Author</label>
                    <form:errors path="author" cssClass="text-danger" />
                    <form:input path="author" class="form-control" placeholder="Enter Author name"/>
                    
                    <label>Link</label>
                    <form:errors path="externalLink" cssClass="text-danger" />
                    <form:input path="externalLink" class="form-control" placeholder="Enter External Link"/>
                    
                    <label>Image</label>
                    <form:errors path="image" cssClass="text-danger" />
                    <form:input path="image" class="form-control" placeholder="Enter Blog Image"/>
                    
                    <br><br>
                    
                    <div class="custom-control custom-checkbox">
                  	<form:checkbox class="custom-control-input" id="customCheckbox1" path="isOnPage" />
                  	<label for="customCheckbox1" class="custom-control-label">Show Blog On Page</label>
                  	</div>
